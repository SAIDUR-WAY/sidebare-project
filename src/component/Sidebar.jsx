...
const Sidebar = () => {
     ...
     return (
          <div className={`bg-[#081A51] text-white h-screen  relative p-4 pt-8 ${open ? 'w-72' : 'w-14' } duration-300 `}>
               ...
               <div className= {`flex items-center rounded-md bg-gray-700 ${!open ? 'p-1' : 'p-2.5'} mt-2`}>
